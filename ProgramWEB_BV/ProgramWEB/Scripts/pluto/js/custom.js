...
window.addEventListener('online', () => {
    $('#sidebar-status').parent().attr('class', 'online')
    $($('#sidebar-status').parent().children()[1]).text('Online')
})

window.addEventListener('offline', () => {
    $('#sidebar-status').parent().attr('class', 'offline')
    $($('#sidebar-status').parent().children()[1]).text('Offline')
})

$('.dropdown-toggle').click((e) => {
    $($(e.currentTarget).parent().children()[1]).toggle(300)
})